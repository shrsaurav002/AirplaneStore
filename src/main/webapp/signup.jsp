...
<body>
	...
	<div class="jumbotron" style="background-color: #ABC123">
		<div class="header">
			<div class="Logo">
				<img src="logoairlines.png" style="height: 150px;">
			</div>
	...
	<form action="" style="border: 1px solid #ccc">
		<div class="container" style="background-color: #3ab8BD">
			...
			<label for="fname"><b>First Name</b></label> <input type="text"
				placeholder="Enter F.Name" name="fname" required> <label
				for="lname"><b>Last Name</b></label> <input type="text"
				placeholder="Enter l.Name" name="lname" required> <label
				...
				required> <label>Gender</label> <select name="gender"
				class="form-control">
				<option>Male</option>
				<option>Female</option>
			</select> <label> <input type="checkbox" checked="checked"
